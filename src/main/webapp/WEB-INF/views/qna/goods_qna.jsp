...
<link rel="stylesheet" href="${pageContext.request.contextPath }/assets/css/goods_userPage.css">
<link href="https://fonts.googleapis.com/css?family=Noto+Sans+KR&display=swap" rel="stylesheet">

<script type="text/javascript" src="http://code.jquery.com/jquery-3.4.1.min.js"></script>
<script src="${pageContext.request.contextPath }/assets/js/goods_qna.js?alert"></script>
</head>
<body>
<div class="main">
...
$(document).ready(function(){
	$.ajax({
		type:'post',
		url:'/miniproject/qna/goods_qnaAllList',
		dataType:'json',
